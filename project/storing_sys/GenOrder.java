...
public class GenOrder {
	   ...
	   public static void main(String[] args){
	        ...
	        top( custom,goods,number);
	   }
	   
	   
	   
	   
	   public static String top(String[] custom,String [][]goods,String number){      
	        
	        String [][]data1 = genadd(custom,number);

	        String [][]data2 = genitem(goods);
	        
	        String [][]data3 = gendig(goods,custom);
	        
	        lowerLevel(data1, data2,data3,number);
	        
	        String tt[] = gentax( goods,custom);
...
//	        sdf.applyPattern("yyyy/MM/dd");// a为am/pm的标记  
	   ...
	   public static String[][] genadd(String [] input,String Invoice )  // add Invoice Number here...
	   {
		   ...
		   String[][] res =
			   {
					 new String[]{"Sold To:",""},   
					 new String[]{"    "+input[1],"Invoice Number: "+Invoice},
					 new String[]{"    "+input[2],"Date: "+ sysTime},
					 new String[]{"    "+input[3]+", "+input[4]+ " " + input[5] ,"P.O.Number:"},
					 new String[]{"    Tel: "+input[6] ,"Terms: 30 days"}
			   };
		   return res;
	   }
	   ...
	   public static void lowerLevel( String [][]data2 ,String [][]data ,String [][]data3,String Invoice)
	   {
	        //创建Document对象
...
//	        table2.autoFit(AutoFitBehaviorType.Auto_Fit_To_Contents);
	        ...
	        //保存文档
	        doc.saveToFile("./img/Invoice_"+Invoice+".docx", FileFormat.Docx_2013);
